...
class RecipesTableSeeder extends Seeder
{
	...
	* Run the database seeds.
		...
		DB::table('recipes')->insert([
		            ...
		            'recipe_text' => '1 - Éplucher partiellement les aubergines, les couper en gros cubes. <br> 2 - Les cuire à la vapeur avec le citron émincé finement et gousse d\'ail coupée en morceau durant 15 minutes. <br> 3 - Dans une poêle faire chauffer l\'huile d\'olive et le concentrée de tomates, bien mélanger. <br> 4 - Ajouter les aubergines cuites avec le citron et l\'ail, bien mélanger et écraser avec une fourchette (sur le feu). <br> 5 - Au bout de 5 minutes retirer du feu, ajouter des herbes fraîches ciselées. <br> 6 - Déguster froid en entrée.',
		            'front_view' => false,
		        ]);
	}
}
